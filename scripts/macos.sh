...
# Keep press-and-hold enabled for umlauts
...
# Save screenshots to the Downloads folder under a subfolder
mkdir -p "${HOME}/Downloads/sshots"
defaults write com.apple.screencapture location "${HOME}/Downloads/sshots"

# Screenshot name prefix
defaults write com.apple.screencapture name "SS"

# Screenshot remove date
...
for app in "Dock" "Finder" "Messages" "Photos" "Safari" "SystemUIServer" "cfprefsd"; do
